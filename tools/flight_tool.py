...
#Below 2 lines to resolve the path issue
...
def clean_text(text:str) ->str:
    ...
    stop_words = [
        "flights", "flights", "ticket", "tickets", "trip", "travel",
...
#If you give the text it will return the country code
def country_name_to_code(text: str):
    ...
    return None
# if you give the airports and country code it will list the airports
